...
export function HudCircularDisplay({ isRecording, isProcessing, onClick, disabled }: HudCircularDisplayProps) {
    ...
    <div className="relative w-[320px] h-[320px] md:w-[400px] md:h-[400px]">
      ...
      >
        ...
        {Array.from({ length: 24 }).map((_, i) => (
          <div
            key={i}
            className="absolute text-primary/60 text-[8px] font-mono"
            style={{
              left: "50%",
              top: "6px",
      ...
      >
        ...
        {Array.from({ length: 12 }).map((_, i) => (
          <div
            key={i}
            className="absolute bg-primary/20 h-4 w-8 rounded-sm"
            style={{
              left: "50%",
              top: "4px",
